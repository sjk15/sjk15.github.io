...
Exempelvis: Utvecklare-Primärt, QA-Sekundärt  eller QA-Primärt, Utvecklare-Kan inte tänka mig
...
_Hur mycket extra jobb kommer det innebära att vara team lead för en av grupperna gentemot att bara vara vanlig utvecklare/QA?_

Det behöver inte vara extra arbete i form av att det är extra många timmar utan det är väl snarare så att den som är team lead kommer lägga en viss mängd av sin tid på det istället för att bara koda. Det jag ser som huvuuppgifterna är:
  - hålla i dagliga standup-möten
  - vara första kontaktperson mot mig(Morten)
  - ha hand om gruppens frågor på de 1-2 veckomöten vi har
  - hålla lite ordning så att JIRA-boarden är uppdaterad från alla i gruppen

_Hur ser arbetsfördelningen ut mellan utvecklare/QA? Är det någon av grupperna som kommer få arbeta hårdare?_

Så behöver det inte vara. Vi kommer att anpassa mängden servicar vi hinner utveckla till den tid vi har, så det är snarare tiden som är låst än scopet, så det blir en bra arbetsmängd för alla. Dock finns det nog lite mer frihet på utvecklarsidan, om någon vill sitta väldigt mycket så finns det inget som hindrar det där (vi har en lång backlog) medan QA-teamet kommer behöva begränsa sig till att skriva tester för servicar som är eller i alla fall håller på att bli utvecklade
