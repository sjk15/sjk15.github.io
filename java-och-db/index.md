...
Uppgift där man får testa på SQL Injection på en testsida. Varning testa detta enbart på dessa test-sidan och absolut INTE på någon riktigt hemsida. Uppgiften är från en laboration en kurs om datasäkerhet på KTH. 
